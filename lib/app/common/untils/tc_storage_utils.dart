...
import 'tc_encrypt_utils.dart';

/// AES 加密存储
class TcAESStorageUtils {
  /// 存 String
  static Future<bool>? saveString(String key, String value) {
    key = TCEncryptUtils.aesEncrypt(key);
    value = TCEncryptUtils.aesEncrypt(value);
  ...
  static String? getString(String key) {
    ...
    if (enValue.isNotEmpty) {
      return TCEncryptUtils.aesDecrypt(enValue);
    }
    return null;
  }
